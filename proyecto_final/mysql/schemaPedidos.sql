...
CREATE TABLE pedidos (
  ...
  bistrocoins_usados INT UNSIGNED NOT NULL DEFAULT 0,
  bistrocoins_ganados INT UNSIGNED NOT NULL DEFAULT 0,
...
CREATE TABLE pedido_lineas (
  ...
  bistrocoins_unit INT UNSIGNED DEFAULT NULL,
  bistrocoins_total INT UNSIGNED DEFAULT NULL,
